...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Старт продаж — <b>июль 2026</b>. Сейчас идёт закрытая бета на&nbsp;25&nbsp;000 человек: тестируем систему ухода до&nbsp;момента, когда корм будет в&nbsp;продаже.',
  },
  {
    cat: 'product',
    q: 'А ветеринар?',
  ...
  {
    cat: 'beta',
    q: 'Что значит «ранний доступ на&nbsp;25 000»?',
